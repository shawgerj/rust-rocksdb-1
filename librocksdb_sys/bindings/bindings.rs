...
pub const crocksdb_table_file_creation_reason_flush: _bindgen_ty_1 = 0;
pub const crocksdb_table_file_creation_reason_compaction: _bindgen_ty_1 = 1;
pub const crocksdb_table_file_creation_reason_recovery: _bindgen_ty_1 = 2;
pub const crocksdb_table_file_creation_reason_misc: _bindgen_ty_1 = 3;
...
extern "C" {
    pub fn crocksdb_write_wotr(
        ...
        options: *const crocksdb_writeoptions_t,
        batch: *mut crocksdb_writebatch_t,
        lenoffsets: *mut usize,
        errptr: *mut *mut libc::c_char,
    ) -> *mut usize;
}
extern "C" {
    pub fn crocksdb_write_wotr_destroy(list: *mut usize);
}
extern "C" {
...
pub const crocksdb_block_based_table_index_type_binary_search: _bindgen_ty_2 = 0;
pub const crocksdb_block_based_table_index_type_hash_search: _bindgen_ty_2 = 1;
pub const crocksdb_block_based_table_index_type_two_level_index_search: _bindgen_ty_2 = 2;
...
extern "C" {
    pub fn crocksdb_options_set_avoid_flush_during_shutdown(
        arg1: *mut crocksdb_options_t,
        arg2: libc::c_int,
    );
}
...
pub const crocksdb_tolerate_corrupted_tail_records_recovery: _bindgen_ty_3 = 0;
pub const crocksdb_absolute_consistency_recovery: _bindgen_ty_3 = 1;
pub const crocksdb_point_in_time_recovery: _bindgen_ty_3 = 2;
pub const crocksdb_skip_any_corrupted_records_recovery: _bindgen_ty_3 = 3;
...
pub const crocksdb_no_compression: _bindgen_ty_4 = 0;
pub const crocksdb_snappy_compression: _bindgen_ty_4 = 1;
pub const crocksdb_zlib_compression: _bindgen_ty_4 = 2;
pub const crocksdb_bz2_compression: _bindgen_ty_4 = 3;
pub const crocksdb_lz4_compression: _bindgen_ty_4 = 4;
pub const crocksdb_lz4hc_compression: _bindgen_ty_4 = 5;
...
pub const crocksdb_level_compaction: _bindgen_ty_5 = 0;
pub const crocksdb_universal_compaction: _bindgen_ty_5 = 1;
pub const crocksdb_fifo_compaction: _bindgen_ty_5 = 2;
...
pub const compaction_by_compensated_size: _bindgen_ty_6 = 0;
pub const compaction_by_oldest_largestseq_first: _bindgen_ty_6 = 1;
pub const compaction_by_oldest_smallest_seq_first: _bindgen_ty_6 = 2;
pub const compaction_by_min_overlapping_ratio: _bindgen_ty_6 = 3;
...
pub const env_io_priority_low: _bindgen_ty_7 = 0;
pub const env_io_priority_high: _bindgen_ty_7 = 1;
pub const env_io_priority_total: _bindgen_ty_7 = 2;
...
pub const crocksdb_similar_size_compaction_stop_style: _bindgen_ty_8 = 0;
pub const crocksdb_total_size_compaction_stop_style: _bindgen_ty_8 = 1;
...
fn bindgen_test_layout_ctitandb_blob_index_t() {
    const UNINIT: ::std::mem::MaybeUninit<ctitandb_blob_index_t> =
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).file_number) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).blob_offset) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ctitandb_blob_index_t),
...
extern "C" {
    pub fn wotr_head(w: *mut wotr_t) -> isize;
}
extern "C" {
...
extern "C" {
    pub fn wotr_iter_init(w: *mut wotr_t, errptr: *mut *mut libc::c_char) -> *mut wotr_iter_t;
}
extern "C" {
    pub fn wotr_iter_seek(wi: *mut wotr_iter_t, offset: usize);
}
extern "C" {
    pub fn wotr_iter_next(wi: *mut wotr_iter_t);
}
extern "C" {
    pub fn wotr_iter_valid(wi: *mut wotr_iter_t) -> libc::c_int;
}
extern "C" {
    pub fn wotr_iter_key(wi: *mut wotr_iter_t) -> *mut libc::c_char;
}
extern "C" {
    pub fn wotr_iter_value(wi: *mut wotr_iter_t) -> *mut libc::c_char;
}
extern "C" {
    pub fn wotr_iter_key_size(wi: *mut wotr_iter_t) -> usize;
}
extern "C" {
    pub fn wotr_iter_value_size(wi: *mut wotr_iter_t) -> usize;
}
extern "C" {
    pub fn wotr_iter_position(wi: *mut wotr_iter_t) -> usize;
}
extern "C" {
