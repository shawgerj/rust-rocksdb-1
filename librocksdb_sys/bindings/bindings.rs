...
extern "C" {
    pub fn wotr_iter_read(wi: *mut wotr_iter_t, e: *mut entry_t) -> libc::c_int;
}
extern "C" {
    pub fn wotr_iter_set_offset(wi: *mut wotr_iter_t, offset: usize);
}
extern "C" {
    pub fn wotr_iter_next(wi: *mut wotr_iter_t);
}
extern "C" {
    pub fn wotr_iter_read_key(wi: *mut wotr_iter_t) -> *mut libc::c_char;
}
extern "C" {
